                        ...
                        <div class="col-md-12">
                            ...
                            <div class="collapse navbar-collapse navbar-right" id="mynavbar">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="http://localhost/mechain/php/fiturMechanic/registBengkel.php">Regist Bengkel</a></li>
                                    <li><a href="http://localhost/mechain/php/fiturMechanic/artikel.php">Article</a></li>
                                    <li class="active"><a href="http://localhost/mechain/php/fiturMechanic/location.php">Location</a></li>
