            ...
            <div class="bg-color">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="collapse navbar-collapse navbar-right" id="mynavbar">
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="<?php echo base_path('php/users/mechanic.php'); ?>">Home</a></li>
                ...
                <div class="container text-center">
                    <div class="wrapper wow fadeInUp delay-05s">
                        ...
                        <button type="submit" class="btn btn-submit"><a href="<?php echo base_path('php/fiturMechanic/registBengkel.php'); ?>" style="color: #000; text-decoration: none;">Daftar</a></button>
                    </div>
                </div>
            </div>
        </header>
