...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="cta-info text-center">
            <h3>
              Kita tidak berfikir apa yang dirasakan mesin<br />
              Sebaliknya kita merasakan apa yang mesin pikirkan<br />-Antonio
              Damasio-
            </h3>
          </div>
        </div>
        ...
        <div class="swiper swiper1">
          <div class="information-cards swiper-wrapper">
            <div class="information-card swiper-slide">
              ...
              <h5>Karya Motor</h5>
              <h6>
                Jl. TGH. Faesal No.9, Mandalika, Kec. Sandubaya, Kota Mataram,
                Nusa Tenggara Bar. 83233
              </h6>
            </div>
            <div class="information-card swiper-slide">
              <iframe
              ...
              <h6>
                Jl. Arif Rahman Hakim No.7, Mataram Tim., Kec. Mataram, Kota
                Mataram, Nusa Tenggara Bar. 83217
              </h6>
            </div>
            <div class="information-card swiper-slide">
              <iframe
              ...
              <h5>Bengkel Wero</h5>
              <h6>
                Jl. Arif Rahman Hakim No.17, Mataram Tim., Kec. Mataram, Kota
                Mataram, Nusa Tenggara Bar. 83127
              </h6>
            </div>
            <div class="information-card swiper-slide">
              <iframe
              ...
              <h6>
                Jl. Swakarya Raya No.4, Pagesangan, Kec. Sekarbela, Kota
                Mataram, Nusa Tenggara Bar. 83127
              </h6>
            </div>
            <div class="information-card swiper-slide">
              ...
              <h6>
                C3HR+FW7, Moncok telaga mas, Jl. Lestari Gg, Kec. Ampenan, Kota
                Mataram, Nusa Tenggara Bar. 83113
              </h6>
            </div>
            <div class="information-card swiper-slide">
              <iframe
              ...
              <h6>
                jl dr soetomo ruko no 1 marong jamak selatan, Kota Mataram, Nusa
                Tenggara Bar. 83122
              </h6>
            </div>
            <div class="information-card swiper-slide">
              ...
              <h6>
                Jalan Anca 7 No.10, Pagesangan Bar., Kec. Mataram, Kota Mataram,
            ...
            <div class="information-card swiper-slide">
              ...
              <h6>
                Jl. Guru Bangkol Blok A No.3, Pagesangan Tim., Kec. Mataram,
                Kota Mataram, Nusa Tenggara Bar. 83127
              </h6>
            </div>
          </div>
        </div>
    ...
    <section class="artikel">
      <h2 class="section-title-inf" style="color: #f8f8f8">
        REKOMENDASI ARTIKEL
      </h2>
      <div class="container-grid">
        <ul>
          <li
            class="booking-card"
            style="
              background-image: url('https://www.suzukicdn.com/uploads/news/Nex_II_(1)2.jpg');
            "
          >
            <div class="book-container">
              <div class="content">
                <button class="btn">
                  <a
                    href="https://www.suzuki.co.id/tips-trik/5-cara-merawat-motor-baru-yang-wajib-diperhatikan?pages=all"
                    >Baca Artikel</a
                  >
                </button>
              </div>
            ...
            <div class="informations-container">
              <h2 class="title-inf">
                5 Cara Merawat Motor Baru yang Wajib Diperhatikan Para Pengguna
              </h2>
              ...
              <div class="more-information">
                ...
                <p class="disclaimer">
                  Servis rutin memang menjadi agenda rutin yang wajib dilakukan
                  pemilik sepeda motor jika ingin kendaraannya awet. Untungnya
                  setiap sepeda motor baru akan dilengkapi dengan layanan servis
                  gratis yang bisa diakses di bengkel resmi.
                </p>
              </div>
            </div>
          </li>
          <li
            class="booking-card"
            style="
              background-image: url(https://media.suara.com/pictures/653x366/2022/01/25/97025-ilustrasi-mengecek-mesin-sepeda-motor-pexels.webp);
            "
          >
            <div class="book-container">
              <div class="content">
                <button class="btn">
                  <a
                    href="https://yoursay.suara.com/lifestyle/2022/01/25/185112/4-cara-merawat-mesin-sepeda-motor-agar-tetap-awet"
                    >Baca Artikel</a
                  >
                </button>
              </div>
            ...
            <div class="informations-container">
              ...
              <div class="more-information">
                ...
                <p class="disclaimer">
                  Tidak dipungkiri lagi bahwa sepeda motor merupakan suatu
                  kendaraan yang praktis serta mudah digunakan oleh semua
                  kalangan. Banyak dari kalangan masyarakat memilih kendaraan
                  dengan roda dua ini.
                </p>
              </div>
            </div>
          ...
          <li
            class="booking-card"
            style="
              background-image: url(https://d1n6dbtoa2690v.cloudfront.net/article/592bde3e150ba016529b3916/592bde3e150ba016529b3916_1603770047.webp);
            "
          >
            <div class="book-container">
              <div class="content">
                <button class="btn">
                  <a
                    href="https://www.pricebook.co.id/article/tips_tricks/6726/kerusakan-motor-matic"
                    >Baca Artikel</a
                  >
                </button>
              </div>
            ...
            <div class="informations-container">
              <h2 class="title-inf">
                5 Kerusakan Umum Motor Matic dan Cara Cepat Mengatasinya
              </h2>
              ...
              <div class="more-information">
                ...
                <p class="disclaimer">
                  Motor matik telah menjadi fenomena di pasar otomotif di
                  Indonesia dan berhasil mengalahkan penjualan motor sport dan
                  bebek yang mulai ditinggalkan.
                </p>
              </div>
            </div>
          </li>
          <li
            class="booking-card"
            style="
              background-image: url(https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1634787819/pqi209szrlcqffku5ogp_tpxmk7.jpg);
            "
          >
            <div class="book-container">
              <div class="content">
                <button class="btn">
                  <a
                    href="https://kumparan.com/info-otomotif/cara-mengatasi-motor-tidak-bisa-hidup-cek-langkah-alternatif-berikut-1wlLBiY0MkP/full"
                    >Baca Artikel</a
                  >
                </button>
              </div>
            ...
            <div class="informations-container">
              <h2 class="title-inf">
                Cara Mengatasi Motor Tidak Bisa Hidup, Cek Langkah Alternatif
                Berikut
              </h2>
              ...
              <div class="more-information">
                ...
                <p class="disclaimer">
                  Bagaimana cara mengatasi motor tidak bisa hidup walaupun sudah
                  distarter berkali-kali? Tenang, mungkin Anda bisa mengecek
                  dulu di mana persoalannya.
                </p>
              </div>
            </div>
          </li>
          ...
          <div class="col-md-8 col-sm-12">
            <div class="section-title">
              ...
              <p class="sec-para black">
                Hubungi kami jika ada komentar dan saran mengenai keadaan
                website dan rekomendasi fitur.
              </p>
            </div>
          </div>
          <div class="col-md-12 col-sm-12">
            <div class="col-md-4 col-sm-6" style="padding-left: 0px">
              ...
              <div class="contact-info">
                <form
                  action="php/config/configContact.php"
                  method="post"
                  role="form"
                  class="contactForm"
                >
            ...
            <div class="col-md-4 col-sm-6">
              ...
              <div class="location-info">
                <p class="white">
                  <span aria-hidden="true" class="fa fa-map-marker"></span>Jl.
                  Majapahit No. 62 Mataram, Nusa Tenggara Barat Indonesia
                </p>
                <p class="white">
                  <span aria-hidden="true" class="fa fa-phone"></span>Phone: +62
                  878 6569 3246
                </p>
                <p class="white">
                  <span aria-hidden="true" class="fa fa-envelope"></span>Email:
                  <a href="mailto:ryanfajri28@gmail.com" class="link-dec"
                    >ryanfajri28@gmail.com</a
                  >
                </p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7 footer-copyright">
            © Zain reserved
            <div class="credits">Designed by <a>Rusdy Team</a></div>
          </div>
